...
class MainActivity : AppCompatActivity() {
    ...
    private fun showMore() {
        ...
        addSection(
            "MORE",
            "Complete UDAAN AI control center"
        )

        moduleButton(
            "🎬",
            "VIDEO STUDIO",
            "AI video creation and final video management"
        ) {
            showVideoStudio()
        }
        ...
        moduleButton(
            "📺",
            "YOUTUBE",
            "Connect, manage and publish to YouTube"
        ) {
            sendCommand(
                "open YouTube AI"
            )
        ...
        moduleButton(
            "📱",
            "INSTAGRAM",
            "Connect and manage Instagram publishing"
        ) {
            sendCommand(
                "open Instagram AI"
            )
        ...
        moduleButton(
            "📱",
            "APP BUILDER",
            "Build applications with UDAAN AI"
        ) {
            showAppBuilder()
        }
        ...
        moduleButton(
            "🔐",
            "FOUNDER APPROVAL",
            "Review and approve consequential actions"
        ) {
            showApprovals()
        }
