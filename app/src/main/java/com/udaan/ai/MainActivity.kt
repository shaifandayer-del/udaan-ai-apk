...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey get() = BuildConfig.UDAAN_FOUNDER_API_KEY
    ...
    private fun addFuturisticHero() {
        ...
        textBox.addView(TextView(this).apply {
            text = "Welcome Back,"
            textSize = 13f
            setTextColor(Color.parseColor("#86A5D0"))
        })
        ...
        textBox.addView(TextView(this).apply {
            ...
            textSize = 12f
            setTextColor(Color.parseColor("#A7B8D2"))
            setPadding(0, 5, 0, 12)
        })

        textBox.addView(Button(this).apply {
            text = "⚡  TAP TO START"
            textSize = 10f
            setTextColor(Color.WHITE)
            background = gradient(
        ...
        }, LinearLayout.LayoutParams(155, 48))
    ...
    private fun addCommandBox() {
        ...
        }, LinearLayout.LayoutParams(-1, 50).apply {
            topMargin = 9
        })
    ...
    private fun gradient(
        ...
        return GradientDrawable(
            ...
            setStroke(
                1,
                Color.parseColor("#153F70")
            )
        }
    }

    private fun setCommandAndExecute(
        command: String
    ) {
        sendCommand(command)
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        paint.shader = RadialGradient(
            ...
            intArrayOf(
                ...
                Color.argb(180, 40, 110, 255),
                Color.argb(90, 100, 40, 255),
                Color.argb(0, 0, 0, 0)
            ),
            floatArrayOf(
                0f,
